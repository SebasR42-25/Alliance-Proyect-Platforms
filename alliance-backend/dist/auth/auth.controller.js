...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Inicio de sesión exitoso, retorna el JWT.' }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Login/registro vía OAuth (Google, Microsoft, Facebook)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Usuario autenticado vía OAuth, retorna JWT.' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [oauth_login_dto_1.OAuthLoginDto]),
    __metadata("design:returntype", Promise)
